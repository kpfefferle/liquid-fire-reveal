...
var r=t.pop(),o=t
return(0,i.setListeners)(r,o),r},e.removeListener=w,e.sendEvent=x,e.isNone=function(e){return null==e},e.isEmpty=ct
...
void 0!==e.readableChains()&&e.writableChains(he)},e.removeChainWatcher=me,e.getChainTagsForKey=$e,e.watchPath=_e,e.unwatchPath=Ee,e.isWatching=function(e,t){return xe(e,t)>0},e.unwatch=Te,e.watch=we,e.watcherCount=xe,e.getProperties=function(e,t){var n={},r=arguments,i=1
...
i&&(i.isSourceDestroying()||i.isMetaDestroyed())?Re.delete(n):t.forEach((function(t,r){if(!(0,a.validate)(t.tag,t.lastRevision)){var i=function(){try{x(n,r,[n,t.path])}finally{t.tag=(0,a.combine)($e(n,t.path)),t.lastRevision=(0,a.value)(t.tag)}}
...
if(!n.isMetaDestroyed())return n.writableTag()}return a.CONSTANT_TAG},e.markObjectAsDirty=ae,e.consume=ee,e.tracked=K,e.track=Z,e.untrack=ne,e.isTracking=te,e.addNamespace=function(e){vt.unprocessedNamespaces=!0,yt.push(e)},e.classToString=xt,e.findNamespace=function(e){mt||wt()
...
o.isPrototypeMeta(e)||function(e){Re.has(e)&&Re.get(e).forEach((function(t){t.tag=(0,a.combine)($e(e,t.path)),t.lastRevision=(0,a.value)(t.tag)}))
ke.has(e)&&ke.get(e).forEach((function(t){t.tag=(0,a.combine)($e(e,t.path)),t.lastRevision=(0,a.value)(t.tag)}))}(e),"function"==typeof e.didDefineProperty&&e.didDefineProperty(e,t,l)}function N(e,t,n){var i=void 0===n?(0,r.meta)(e):n,o=i.peekWatching(t)
...
return ee(n),s&&!o.has(this)?(e=r.call(this),o.set(this,e)):e=o.get(this),(Array.isArray(e)||(0,i.isEmberArray)(e))&&(0,a.update)(n,oe(e,"[]")),e},set:function(e){ae(this,t),o.set(this,e),null!==re&&re()}}}e.Tracker=$
var J=null
function Z(e,t){var n=J,r=new $
J=r
...
i.writeWatching(t,o+1),0===o&&i.writableChains(he).add(t)}function Ee(e,t,n){var i=void 0===n?(0,r.peekMeta)(e):n
if(null!==i){var o=i.peekWatching(t)
o>0&&(i.writeWatching(t,o-1),1===o&&i.writableChains(he).remove(t))}}function we(e,t,n){A(t)?_e(e,t,n):N(e,t,n)}function xe(e,t){var n=(0,r.peekMeta)(e)
return null!==n&&n.peekWatching(t)||0}function Te(e,t,n){A(t)?Ee(e,t,n):M(e,t,n)}e.ChainNode=be
...
n&&(n.isSourceDestroying()||n.isMetaDestroyed())?ke.delete(t):e.forEach((function(e,n){if(!e.suspended&&!(0,a.validate)(e.tag,e.lastRevision))try{e.suspended=!0,x(t,n,[t,e.path])}finally{e.tag=(0,a.combine)($e(t,e.path)),e.lastRevision=(0,a.value)(e.tag),e.suspended=!1}}))}))}function Ne(e,t,n){var r=ke.get(e)
...
else for(var u in o){var l=o[u];(0,a.update)(l,(0,a.combine)($e(n,u))),delete o[u]}}function Qe(e,t){for(var n=[],r=0;r<t.length;r++)n.push.apply(n,$e(e,t[r]))
...
n<0?t(e.replace(Ke,".[]")):function e(t,n,r,i){var o,a,s=n.indexOf("}"),u=0,l=n.substring(r+1,s).split(","),c=n.substring(s+1)
t+=n.substring(0,r),a=l.length
for(;u<a;)(o=c.indexOf("{"))<0?i((t+l[u++]+c).replace(Ke,".[]")):e(t+l[u++],c,o,i)}("",e,n,t)}function Je(e,t,n,o){if(!e.isDestroyed){if(A(t))return Ze(e,t,n,o)
...
var o=p(e,t)
return(0,a.validate)(i,o)||((0,a.update)(i,(0,a.combine)($e(e,this.altKey))),h(e,t,(0,a.value)(i)),Ye(e,t,n)),ee(i),n},r.unconsume=function(e,t,n){var r=y(e,t)===ot;(r||n.peekWatching(t)>0)&&B(this,e,t,n),r&&g(e).delete(t)},r.consume=function(e,t,n){var r=g(e)
r.get(t)!==ot&&(r.set(t,ot),function(e,t,n,r){var i=e._dependentKeys
if(null!=i)for(var o=0;o<i.length;o++){var a=i[o]
r.writeDeps(a,n,r.peekDeps(a,n)+1),we(t,a,r)}}(this,e,t,n))},r.set=function(e,t,n){return Je(e,this.altKey,n)},r.readOnly=function(){this.set=ut},r.oneWay=function(){this.set=lt},n}(U)
...
return Ember.isArray(n.use)?(r=n.use[0],i=n.use.slice(1)):(r=n.use,i=[]),o="function"==typeof r?r:e.lookup(r),function(){return t.Promise.resolve(o.apply(this,i))}})(e,n).apply(e).then(r,i)}))}function o(e,r,i){if(!e.oldElement||!e.newElement)return t.Promise.resolve()
var o
r.pick&&(e.oldElement=e.oldElement.find(r.pick),e.newElement=e.newElement.find(r.pick)),r.pickOld&&(e.oldElement=e.oldElement.find(r.pickOld)),r.pickNew&&(e.newElement=e.newElement.find(r.pickNew)),o="id"===r.matchBy?function(e){return"#".concat(e)}:"class"===r.matchBy?function(e){return".".concat(e)}:function(e){var t=e.replace(/'/g,"\\'")
...
return""===s||0===e.newElement.find(o(s)).length?t.Promise.resolve():n(e,{pick:o(s),use:r.use},i)})))}Object.defineProperty(e,"__esModule",{value:!0}),e.default=function(){for(var e=this,r={},a=!1,s=arguments.length,u=new Array(s),l=0;l<s;l++)u[l]=arguments[l]
var c=u.map((function(t){return t.matchBy?o(e,t,r):t.pick||t.pickOld||t.pickNew?n(e,t,r):(a=!0,i(e,t))}))
